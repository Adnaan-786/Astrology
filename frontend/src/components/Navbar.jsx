              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem asChild>
                    <Link to="/profile" className="cursor-pointer av-text">My Profile</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={handleLogout} className="text-red-500 cursor-pointer" data-testid="logout-btn">
